...
int main (int argc, char** argv) {
    ...
    //Ahora que ya tenemos guardado los datos, los utilizamos: 
    ...
    create_local_systems(local_Ks, local_bs, num_elements, &M); //si cambiará. 
    ...
    solve_system(&K, &b, &T);
    cout<<"MOSTRANDO LAS TEMPERATURAS\n"; 
    T.show();
